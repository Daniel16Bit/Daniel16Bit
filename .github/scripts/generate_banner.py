...
THEMES = {
    "dark": {
        "BG": "#060A14", "PANEL": "#0A1120", "BAR": "#070C18",
        "GREEN": "#38BDF8", "GREEN_DIM": "#1E3A8A", "CYAN": "#22D3EE",
        "RED": "#F43F5E", "AMBER": "#FBBF24", "TEXT": "#DBEAFE",
        "MUTED": "#60A5FA", "DIM": "#1E3A5F", "WHITE": "#EFF6FF",
        "LEADER": "rgba(56,189,248,0.20)", "GRIDLINE": "rgba(56,189,248,0.05)",
        "BORDER": "rgba(56,189,248,0.35)", "PANEL_STROKE": "rgba(56,189,248,0.22)",
        "SCAN": "rgba(56,189,248,0.05)",
    },
    "light": {
        "BG": "#F1F5FB", "PANEL": "#FFFFFF", "BAR": "#E2EAF5",
        "GREEN": "#0369A1", "GREEN_DIM": "#1E3A8A", "CYAN": "#0E7490",
        "RED": "#E11D48", "AMBER": "#B45309", "TEXT": "#0F1E3D",
        "MUTED": "#2563EB", "DIM": "#94A8C8", "WHITE": "#0C1B3A",
        "LEADER": "rgba(3,105,161,0.22)", "GRIDLINE": "rgba(3,105,161,0.05)",
        "BORDER": "rgba(3,105,161,0.35)", "PANEL_STROKE": "rgba(3,105,161,0.20)",
        "SCAN": "rgba(3,105,161,0.04)",
    },
}
...
CONFIG = {
    ...
    "boot_lines": [
        ...
        ("$ ", "cat role.txt", None),
        ("", "Red Team Operator", "out"),
        ("$ ", "id --focus", None),
        ("", "PNPT (target)  ·  CRTP  ·  CRTO  ·  OSCP", "out"),
        ("$ ", "uname -a", None),
    ...
    "info": [
        ...
        ("Toolchain", "Kali, Burp, C2, BloodHound"),
        ("Core.Lang", "C, Python, SQL"),
